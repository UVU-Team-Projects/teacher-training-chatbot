...
class StudentProfileBuilder:
    ...
    def __init__(self):
        ...
        self.PROFILE_PROMPT = """
        As an educational expert, analyze the following student description and create a detailed student profile.
    ...
    def build_profile_from_text(self, description: str) -> StudentProfile:
        ...
        messages = prompt.format_messages(description=description)
        ...
        try:
            ...
            interests = self._validate_interests(profile_data.get('interests', []))
            ...
            return StudentProfile(
                ...
                academic_challenges=profile_data.get('academic_challenges', []),
...
def main():
    ...
    try:
        ...
        print(f"Key personality traits: {', '.join(profile.personality_traits)}")
